...
void MatrixModelStructure::addVertex(const Vertex &vertex)
{
    ...
    //std::cout << "addVertex newSize: " << newSize << endl;
...
{
    //std::cout << "addEdge: " << edge.getFirst() << " " << edge.getSecond() << " " << _adjMatrix.get_rows() << _adjMatrix.get_cols() << endl;
    _adjMatrix[edge.getFirst() - 1][edge.getSecond() - 1] = 1;
}
